...
const adminPointRequestChannel =
    DISCORD_CONFIG.discordAdminPointRequestChannel || '1309628262456098878';
...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            const channelSend = await interaction.client.channels.fetch(adminPointRequestChannel);
